...
export function implementJob(Job: typeof JobClass): typeof JobClass {
    ...
    Object.defineProperty(Job.prototype.annotations.truncate, 'implementation', {
        value: function truncateAnnotationsImplementation(
            this: JobClass,
            objectStates: Parameters<typeof JobClass.prototype.annotations.truncate>[0],
            fromFrame: Parameters<typeof JobClass.prototype.annotations.truncate>[1],
        ): ReturnType<typeof JobClass.prototype.annotations.truncate> {
            return Promise.resolve(getCollection(this).truncate(objectStates, fromFrame));
        },
    });
...
export function implementTask(Task: typeof TaskClass): typeof TaskClass {
    ...
    Object.defineProperty(Task.prototype.annotations.truncate, 'implementation', {
        value: function truncateAnnotationsImplementation(
            this: TaskClass,
            objectStates: Parameters<typeof TaskClass.prototype.annotations.truncate>[0],
            fromFrame: Parameters<typeof TaskClass.prototype.annotations.truncate>[1],
        ): ReturnType<typeof TaskClass.prototype.annotations.truncate> {
            return Promise.resolve(getCollection(this).truncate(objectStates, fromFrame));
        },
    });
