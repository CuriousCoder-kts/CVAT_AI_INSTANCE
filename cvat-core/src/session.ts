    ...
    Object.defineProperties(prototype, {
        annotations: Object.freeze({
            value: {
                ...
                async truncate(objectStates, fromFrame) {
                    const result = await PluginRegistry.apiWrapper.call(
                        this,
                        prototype.annotations.truncate,
                        objectStates,
                        fromFrame,
                    );
                    return result;
...
export class Session {
    public annotations: {
        ...
        truncate: (objectStates: ObjectState[] | ObjectState, fromFrame: number) => Promise<void>;
    ...
    public constructor() {
        ...
        this.annotations = {
            ...
            truncate: Object.getPrototypeOf(this).annotations.truncate.bind(this),
