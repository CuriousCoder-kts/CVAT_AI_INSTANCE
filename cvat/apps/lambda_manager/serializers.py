...
class LabelMappingEntrySerializer(serializers.Serializer):
    # allow_blank: Auto-annotation dialog may send name="" when the task has no
    # matching label yet (custom AI instance labels). Backend fills it from the
    # mapping key and R7/R8 auto-creates the CVAT label.
