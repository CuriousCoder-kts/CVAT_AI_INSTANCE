...
function HeaderComponent(props: Props): JSX.Element {
    ...
    // Side-effect reference: 防止 Terser + webpack production mode 把 ThunderboltOutlined 图标
    // 和 "AI Features" 字符串当成 dead code 移除。因为 HeaderComponent 是根组件，
    // 这里的 window 引用保证打进 chunk。
    if (typeof window !== 'undefined') {
        (window as any).__CVAT_AI_MENU_KEYS__ = {
            label_ai_features: 'AI Features',
            label_bailian_legacy: 'Bailian settings (Legacy)',
            route_ai_features: '/organization/ai-features',
            route_new: '/organization/ai-features/new',
            has_thunderbolt_icon: !!ThunderboltOutlined,
        };
    }
    ...
    const resetOrganization = (): void => {
        ...
        if (/(webhooks)|(bailian)|(ai-features)|(\d+)/.test(window.location.pathname)) {
    ...
    menuItems.push([{
        ...
        children: [
            ...(currentOrganization ? [{
                ...
                icon: <SettingOutlined />,
                label: 'Bailian settings (Legacy)',
                onClick: () => history.push('/organization/bailian'),
            }, {
                key: 'organization_ai_features',
                icon: <ThunderboltOutlined />,
                label: 'AI Features',
                onClick: () => history.push('/organization/ai-features'),
            }] : []), {
                key: 'invitations',
                icon: <MailOutlined />,
                label: 'Invitations',
    ...
    return (
        <Layout.Header className='cvat-header'>
            ...
            <div className='cvat-left-header'>
                ...
                {canUseAcceptance && (
                    <Button
                        className={getButtonClassName('acceptance')}
                        type='link'
                        value='acceptance'
                        href='/acceptance'
                        onClick={(event: React.MouseEvent): void => {
