...
import OrganizationBailianPage from 'components/organization-bailian-page/organization-bailian-page';
import _AIFeatureInstancesPage from 'components/ai-feature-page/list-page';
import _CreateAIFeatureInstancePage from 'components/ai-feature-page/form-page';
import { ShortcutsContextProvider } from 'components/shortcuts.context';

// NOTE: Production Terser minifier + webpack sideEffects 会把只在 <Route component={...}/>
// 里引用的静�?import class 当成 dead code 移除。把这两个组件挂�?window �?// 做一次「真实运行时可见性引用�? 100% 保证打进 bundle。同时保留原来的局部引用�?declare const window: any;
const AIFeatureInstancesPage: any = _AIFeatureInstancesPage;
const CreateAIFeatureInstancePage: any = _CreateAIFeatureInstancePage;
if (typeof window !== 'undefined') {
    window.__CVAT_AI_FEATURE_PAGES__ = { AIFeatureInstancesPage, CreateAIFeatureInstancePage };
}
// 额外二次引用：以字符串形�?require（不能是 static import），webpack 运行时解析不会被摇树
try {
...
import AcceptancePageComponent from 'components/acceptance-page/acceptance-page';
                            ...
                            <Layout>
                                ...
                                <Layout.Content style={{ height: '100%' }}>
                                    ...
                                    <Switch>
                                        ...
                                        <Route exact path='/acceptance' component={AcceptancePageComponent} />
                                        <Route exact path='/tasks/:tid/jobs/:jid/acceptance' component={AcceptancePageComponent} />
                                        ...
                                        <Route exact path='/organization/ai-features' component={AIFeatureInstancesPage} />
                                        <Route exact path='/organization/ai-features/new' component={CreateAIFeatureInstancePage} />
                                        <Route exact path='/organization/ai-features/:slug' component={CreateAIFeatureInstancePage} />
                                    ...
                                    <ImportDatasetModal />
                                    <ImportBackupModal />
                                    <div className='cvat-global-model-runner'>
                                        <ModelRunnerModal />
                                    </div>
                                    <InvitationWatcher />
