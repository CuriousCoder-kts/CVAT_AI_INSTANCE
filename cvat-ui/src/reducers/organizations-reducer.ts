...
export default function (
    ...
    switch (action.type) {
        ...
        case OrganizationActionsTypes.CREATE_ORGANIZATION_MEMBERS: {
            return {
                ...state,
                creatingMembers: true,
            };
        }
        case OrganizationActionsTypes.CREATE_ORGANIZATION_MEMBERS_SUCCESS:
        case OrganizationActionsTypes.CREATE_ORGANIZATION_MEMBERS_FAILED: {
            return {
                ...state,
                creatingMembers: false,
            };
