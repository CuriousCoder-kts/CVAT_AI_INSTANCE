...
import {
    HIDE_SHAPE_TRACK_ID_MARKER,
    visibleObjectAttributes,
} from 'components/annotation-page/standard-workspace/objects-side-bar/shared';
...
class ObjectItemDetailsContainer extends React.PureComponent<Props> {
    ...
    public render(): JSX.Element | null {
        ...
        if (state) {
            ...
            const visibleAttrs = visibleObjectAttributes(state.label.attributes, state.objectType);
            return (
                <div className={HIDE_SHAPE_TRACK_ID_MARKER}>
                    <ObjectItemDetails
                        readonly={readonly}
                        collapsed={collapsed}
